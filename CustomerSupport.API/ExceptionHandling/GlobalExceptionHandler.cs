...
namespace CustomerSupport.API.ExceptionHandling
{
    ...
    public sealed class GlobalExceptionHandler : IExceptionHandler
    {
        ...
        //Input: accepts the HttpContext, the exception that was thrown, and a CancellationToken for async operations.
        //Output: sets apt HTTP status code, message and error details in standardized ApiResponse format,
        //writes it to the response body, and returns true to indicate the exception was handled.
        //Also, logs the exception details using ILogger.
