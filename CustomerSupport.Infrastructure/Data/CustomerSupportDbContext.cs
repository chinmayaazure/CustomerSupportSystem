...
namespace CustomerSupport.Infrastructure.Data
{
    ...
    {
        //DBContextOptions is a class that contains configuration information for the DbContext, such as the database provider (SQL/MySQL etc.), connection string,
        //and other options.
        ...
        /// <summary>
        /// Configures the model and applies entity configurations and seed data.
        /// </summary>
        ...
        private static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            //Identity columns values are to be specifically provided.
            //Auto generation doesn't work for seed data.
            //Also, dynamic data like DateTime.Now, Guid.NewGuid() etc. cannot be used in seed data as they will be evaluated only once at the time of migration creation
            //and will not be updated during subsequent migrations.
