        ...
        public async Task<SupportTicket?> GetByIdAsync(int id, bool trackChanges)
        {
            ...
            return await query
                ...
                .Include(x => x.Comments)
                    .ThenInclude(x => x.User)  //TicketComment Entity has a navigation property to User
                .Include(x => x.History)
                    .ThenInclude(x => x.ChangedByUser) //TicketHistory Entity has a navigation property to User, ChangedByUser
