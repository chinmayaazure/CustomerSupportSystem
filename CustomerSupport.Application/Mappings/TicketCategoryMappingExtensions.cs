...
namespace CustomerSupport.Application.Mappings
{
    ...
    {
        public static TicketCategory ToEntity(this CreateTicketCategoryRequestDTO request,int createdBy)
        {
        ...
        public static void MapFrom(this TicketCategory category,UpdateTicketCategoryRequestDTO request,int updatedBy)
        {
